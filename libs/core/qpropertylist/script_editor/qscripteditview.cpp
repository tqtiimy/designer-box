	...
	m_property(property)
{
	...
	ac = core->get_action("ScriptEdit.Save");
	...
	ac = core->get_action("ScriptEdit.Undo");
	...
	ac = core->get_action("ScriptEdit.Redo");
	...
	ac = core->get_action("ScriptEdit.Cut");
	...
	ac = core->get_action("ScriptEdit.Copy");
	...
	ac = core->get_action("ScriptEdit.Paste");
	...
	ac = core->get_action("ScriptEdit.Zoomin");
	...
	ac = core->get_action("ScriptEdit.Zoomout");
	...
	ac = core->get_action("ScriptEdit.Font");
	...
	ac = core->get_action("ScriptEdit.Search");
...
void QScriptEditView::clipboardDataChanged()
{
	...
	{
		QSoftCore *core = QSoftCore::get_core();
		QAction *ac = core->get_action("ScriptEdit.Paste");
...
void QScriptEditView::insertMethod(const QMetaMethod &method, QAbstractHost *host)
{
	...
	while (!temp->inherits("QProjectHost"))
	{
		...
		else if (temp == m_property_host->get_parent())
		{
			str = "parent." + str;
			break;
		}
