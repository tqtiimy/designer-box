	...
	m_languageComboBox(new QComboBox(this))
{
	...
	ac = core->get_action("FormManager.Add");
	...
	ac = core->get_action("FormManager.Same.Left");
	...
	ac = core->get_action("FormManager.Same.V-Center");
	...
	ac = core->get_action("FormManager.Same.Right");
	...
	ac = core->get_action("FormManager.Same.Top");
	...
	ac = core->get_action("FormManager.Same.H-Center");
	...
	ac = core->get_action("FormManager.Same.Bottom");
	...
	ac = core->get_action("FormManager.Same.Width");
	...
	ac = core->get_action("FormManager.Same.Height");
	...
	ac = core->get_action("FormManager.Same.Gemotry");
...
void QFormWidgetView::project_opened()
{
	...
	QList<QAbstractHost *> pages = manager->get_pages();
	...
	QLanguageManager *l_manager = QSoftCore::get_core()->get_project_core()->get_language_manager();
	...
	ac = core->get_action("FormManager.Del");
...
void QFormWidgetView::language_combo_changed()
{
	...
	QSoftCore::get_core()->get_project_core()->get_language_manager()->set_current_language(uuid);
}
