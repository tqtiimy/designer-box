...
QDriverTabView::QDriverTabView(QWidget *parent) :
	QWidget(parent),
	m_currentIndex(-1),
...
QSize QDriverTabView::minimumSizeHint() const
{
	return QSize(0, 25);
}

void QDriverTabView::insert_data(QAbstractDriver *data, int index)
{
...
void QDriverTabView::remove(QAbstractDriver *data)
{
...
int QDriverTabView::current_index() const
{
	return m_currentIndex;
}

void QDriverTabView::set_current_index(int index)
{
...
void QDriverTabView::paintEvent(QPaintEvent *)
{
	...
	{
		QAbstractDriver *data = m_tabs.at(i);
	...
	for (int i = 0; i <= m_lastVisibleIndex; ++i)
	{
		...
		QAbstractDriver *data = m_tabs.at(actualIndex);
...
void QDriverTabView::mousePressEvent(QMouseEvent *event)
{
	if (!m_stop)
	{
...
QPair<QDriverTabView::HitArea, int> QDriverTabView::convertPosToTab(QPoint pos)
{
...
void QDriverTabView::button_clicked()
{
	QMenu overflowMenu;
...
void QDriverTabView::resizeEvent(QResizeEvent *e)
{
...
void QDriverTabView::set_stop(bool stop)
{
	m_stop = stop;
